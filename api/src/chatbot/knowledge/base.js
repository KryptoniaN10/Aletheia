export const staticKnowledge = {
  ...
  faqs: [
    ...
    {
      keywords: ["how does it work", "how tokenization works", "process", "workflow"],
    ...
    {
      keywords: ["how to invest", "investing", "buy share", "marketplace yield"],
    ...
    {
      keywords: ["kyc", "identity verification", "pan number", "compliance"],
    ...
    {
      keywords: ["fee", "discount rate", "bps", "basis points"],
